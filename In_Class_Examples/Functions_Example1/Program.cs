...
namespace Functions_Example1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (shouldLoopAgain)
            {
                double itemPrice = ValidateInputIsADouble("Please enter the price of the item >>");
                itemPrices.Add(itemPrice);

                shouldLoopAgain = DoesTheUserWantToGoAgain();
                //Console.WriteLine("Do you want to enter another price? yes or no >>");
                //response = Console.ReadLine();
            }
        ...
        /// </summary>
        /// <returns>
        /// True if they answered yes to wanting to input more
        /// False if they answered no to wanting to input more
        /// </returns>
